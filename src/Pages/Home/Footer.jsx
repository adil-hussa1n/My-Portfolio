...
function Footer() {
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/Adil.hussain2345/"
            ...
            <li>
              <a
                href="https://www.instagram.com/adil_hussa1n"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/adil-hussa1n/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <p className="footer--content text-center">Copyright © 2024, All Rights Reserved by ADIL HUSSAIN</p>
  <   div className="footer--social--icon">
         </div>
        </div>
